...
class TokenAuthenticator(
    ...
    override fun authenticate(route: Route?, response: Response): Request? {
        ...
        return if(refreshResponse.isSuccessful) {
            ...
            val newAccessToken = refreshResponse.body()?.data?.tokens?.accessToken ?: return null
            val newRefreshToken = refreshResponse.body()?.data?.tokens?.refreshToken ?: return null
